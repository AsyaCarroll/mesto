export default class Card {
    ...
    _deletePlace() {
        this._popupDelete.open(this, this.cardId, this._elementAdded);
    }
    ...
    _setEventListeners() {
        ...
        this._elementAdded.querySelector('.element__trash').addEventListener('click', () => this._deletePlace(this));
